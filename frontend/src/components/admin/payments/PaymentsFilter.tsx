...
export const PaymentsFilter: React.FC<PaymentsFilterProps> = ({
  ...
  const handleStatusFilterChange = (
    ...
    const value = e.target.value as PaymentTransactionStatus | "";
    onFilterChange({
      ...filters,
      status: value === "" ? undefined : (value as PaymentTransactionStatus),
    });
  };
    ...
    <div className="flex flex-col space-y-4 md:flex-row md:items-center md:space-y-0 md:space-x-4 mb-6">
      ...
      <div className="flex flex-wrap gap-2">
        <select
          ...
          className="w-[170px] py-2 px-3 border border-gray-300 dark:border-gray-600 rounded-md 
                   focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent
                   bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
        >
